...
## What's going on? {data-name="Copulas" style="font-size:60%"}
...
## Have no fear {data-name="Copulas"}

![](images/predator.jpg){fig-align="center"}

## Stan Model {data-name="Copulas" style="font-size:60%"}
...
## Exact Stan Model {data-name="Results" style="font-size:60%"}
